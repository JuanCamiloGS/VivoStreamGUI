...
"}")
        ...
        self.lineEditR0.setGeometry(QtCore.QRect(280, 230, 71, 21))
        ...
        self.lineEditG.setGeometry(QtCore.QRect(40, 120, 71, 21))
        self.lineEditG.setObjectName("lineEditG")
        self.pushButton = QtWidgets.QPushButton(parent=self.page_2)
        self.pushButton.setGeometry(QtCore.QRect(250, 310, 181, 31))
        font = QtGui.QFont()
        ...
        self.horizontalSlider.setGeometry(QtCore.QRect(170, 190, 261, 20))
        ...
        self.label_11.setGeometry(QtCore.QRect(10, 190, 61, 16))
        ...
        self.lineEditTT.setGeometry(QtCore.QRect(100, 190, 51, 21))
        self.lineEditTT.setObjectName("lineEditTT")
        self.textBrowser = QtWidgets.QTextBrowser(parent=self.page_2)
        self.textBrowser.setGeometry(QtCore.QRect(10, 350, 421, 151))
        self.textBrowser.setObjectName("textBrowser")
        self.label_4 = QtWidgets.QLabel(parent=self.page_2)
        self.label_4.setGeometry(QtCore.QRect(250, 230, 21, 20))
        self.label_4.setObjectName("label_4")
        self.label_7 = QtWidgets.QLabel(parent=self.page_2)
        self.label_7.setGeometry(QtCore.QRect(10, 120, 21, 20))
        ...
        self.lineEditBD.setGeometry(QtCore.QRect(100, 230, 51, 21))
        ...
        self.lineEditP.setGeometry(QtCore.QRect(40, 80, 71, 21))
        ...
        self.lineEditTL.setGeometry(QtCore.QRect(100, 270, 51, 21))
        self.lineEditTL.setObjectName("lineEditTL")
        self.label_6 = QtWidgets.QLabel(parent=self.page_2)
        self.label_6.setGeometry(QtCore.QRect(250, 80, 21, 16))
        self.label_6.setObjectName("label_6")
        self.lineEditQ = QtWidgets.QLineEdit(parent=self.page_2)
        self.lineEditQ.setGeometry(QtCore.QRect(280, 80, 71, 21))
        ...
        self.comboBox3.setGeometry(QtCore.QRect(360, 80, 71, 22))
        self.comboBox3.setObjectName("comboBox3")
        self.comboBox3.addItem("")
        self.comboBox4 = QtWidgets.QComboBox(parent=self.page_2)
        self.comboBox4.setGeometry(QtCore.QRect(120, 80, 71, 22))
        self.comboBox4.setObjectName("comboBox4")
        self.comboBox4.addItem("")
        self.comboBox5 = QtWidgets.QComboBox(parent=self.page_2)
        self.comboBox5.setGeometry(QtCore.QRect(360, 230, 71, 22))
        self.comboBox5.setObjectName("comboBox5")
        self.comboBox5.addItem("")
        self.comboBox6 = QtWidgets.QComboBox(parent=self.page_2)
        self.comboBox6.setGeometry(QtCore.QRect(120, 120, 71, 22))
        self.comboBox6.setObjectName("comboBox6")
        self.comboBox6.addItem("")
        self.comboBox7 = QtWidgets.QComboBox(parent=self.page_2)
        self.comboBox7.setGeometry(QtCore.QRect(160, 230, 51, 22))
        self.comboBox7.setObjectName("comboBox7")
        self.comboBox7.addItem("")
        self.comboBox8 = QtWidgets.QComboBox(parent=self.page_2)
        self.comboBox8.setGeometry(QtCore.QRect(160, 270, 51, 22))
        self.comboBox8.setObjectName("comboBox8")
        self.comboBox8.addItem("")
        self.label_27 = QtWidgets.QLabel(parent=self.page_2)
        self.label_27.setGeometry(QtCore.QRect(360, 40, 71, 21))
        self.label_27.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.label_27.setObjectName("label_27")
        self.comboBoxGet = QtWidgets.QComboBox(parent=self.page_2)
        self.comboBoxGet.setGeometry(QtCore.QRect(10, 310, 231, 31))
        self.comboBoxGet.setObjectName("comboBoxGet")
        self.comboBoxGet.addItem("")
        self.comboBoxGet.addItem("")
        self.lineEditH = QtWidgets.QLineEdit(parent=self.page_2)
        self.lineEditH.setGeometry(QtCore.QRect(280, 270, 71, 21))
        self.lineEditH.setObjectName("lineEditH")
        self.label_13 = QtWidgets.QLabel(parent=self.page_2)
        self.label_13.setGeometry(QtCore.QRect(250, 270, 21, 20))
        self.label_13.setObjectName("label_13")
        self.comboBox5_2 = QtWidgets.QComboBox(parent=self.page_2)
        self.comboBox5_2.setGeometry(QtCore.QRect(360, 270, 71, 22))
        self.comboBox5_2.setObjectName("comboBox5_2")
        self.comboBox5_2.addItem("")
        ...
        self.T2Output.setGeometry(QtCore.QRect(300, 130, 41, 21))
        ...
        self.T1Output.setGeometry(QtCore.QRect(300, 80, 41, 21))
        ...
        self.label_21.setGeometry(QtCore.QRect(130, 50, 51, 16))
        font = QtGui.QFont()
        font.setItalic(True)
        self.label_21.setFont(font)
        self.label_21.setObjectName("label_21")
        self.label_22 = QtWidgets.QLabel(parent=self.page_3)
        self.label_22.setGeometry(QtCore.QRect(310, 50, 31, 16))
        font = QtGui.QFont()
        font.setItalic(True)
        self.label_22.setFont(font)
        self.label_22.setObjectName("label_22")
        self.label_23 = QtWidgets.QLabel(parent=self.page_3)
        self.label_23.setGeometry(QtCore.QRect(270, 80, 21, 21))
        font = QtGui.QFont()
        font.setPointSize(18)
        self.label_23.setFont(font)
        self.label_23.setObjectName("label_23")
        self.label_24 = QtWidgets.QLabel(parent=self.page_3)
        self.label_24.setGeometry(QtCore.QRect(270, 130, 21, 21))
        font = QtGui.QFont()
        font.setPointSize(18)
        self.label_24.setFont(font)
        self.label_24.setObjectName("label_24")
        self.comboBoxChip1 = QtWidgets.QComboBox(parent=self.page_3)
        self.comboBoxChip1.setGeometry(QtCore.QRect(200, 80, 61, 22))
        ...
        self.comboBoxChip2.setGeometry(QtCore.QRect(200, 130, 61, 22))
        ...
        self.label_25.setGeometry(QtCore.QRect(214, 50, 41, 16))
        font = QtGui.QFont()
        font.setItalic(True)
        self.label_25.setFont(font)
        self.label_25.setObjectName("label_25")
        self.lineEditMedium2 = QtWidgets.QLineEdit(parent=self.page_3)
        self.lineEditMedium2.setGeometry(QtCore.QRect(60, 130, 41, 21))
        self.lineEditMedium2.setObjectName("lineEditMedium2")
        self.lineEditMedium1 = QtWidgets.QLineEdit(parent=self.page_3)
        self.lineEditMedium1.setGeometry(QtCore.QRect(60, 80, 41, 21))
        self.lineEditMedium1.setReadOnly(False)
        self.lineEditMedium1.setObjectName("lineEditMedium1")
        self.label_12 = QtWidgets.QLabel(parent=self.page_3)
        self.label_12.setGeometry(QtCore.QRect(60, 50, 41, 16))
        font = QtGui.QFont()
        font.setItalic(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEditR0.setText(_translate("MainWindow", "19e-5"))
        ...
        self.lineEditTT.setText(_translate("MainWindow", "6"))
        self.label_4.setText(_translate("MainWindow", "r0"))
        self.label_7.setText(_translate("MainWindow", "g "))
        self.label.setText(_translate("MainWindow", "Flow parameters for perfusion"))
        self.lineEditBD.setText(_translate("MainWindow", "30e-4"))
        ...
        self.label_8.setText(_translate("MainWindow", "Form parameters for perfusion"))
        self.label_3.setText(_translate("MainWindow", "p"))
        self.lineEditTL.setText(_translate("MainWindow", "40e-2"))
        self.label_6.setText(_translate("MainWindow", "Q"))
        self.lineEditQ.setText(_translate("MainWindow", "30e-11"))
        ...
        self.comboBoxGet.setItemText(0, _translate("MainWindow", "Get reservoir height"))
        self.comboBoxGet.setItemText(1, _translate("MainWindow", "Get number of coils"))
        self.lineEditH.setText(_translate("MainWindow", "3"))
        self.label_13.setText(_translate("MainWindow", "h"))
        self.comboBox5_2.setItemText(0, _translate("MainWindow", "cm"))
        ...
        self.lineEditChip1.setText(_translate("MainWindow", "7.1e-10"))
        self.lineEditChip2.setText(_translate("MainWindow", "6.22e-10"))
        self.pushButtonDesign.setText(_translate("MainWindow", "FIND \n"
" DESIGN"))
        self.label_20.setText(_translate("MainWindow", "Chip"))
        self.label_21.setText(_translate("MainWindow", "Flow rate"))
        ...
        self.lineEditMedium2.setText(_translate("MainWindow", "1000"))
        self.lineEditMedium1.setText(_translate("MainWindow", "1000"))
        self.label_12.setText(_translate("MainWindow", "Density"))
